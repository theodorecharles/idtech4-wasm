...
async function launch(message) {
  ...
  try {
    ...
    if (persistence.frameworkScript !== '/shared-shell/wasm-game-framework.js' || persistence.frameworkVersion !== '0.9.1') {
      throw new Error('Prey requires the exact wasm-game-framework 0.9.1 worker persistence contract.');
    }
